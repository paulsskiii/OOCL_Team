...
public class CargoService {
    ...
    public List<CargoItem> searchCargoByOriginAndDestination(String origin, String destination) {
        return cargoRepository.findByOriginAndDestination(origin, destination);
    }
