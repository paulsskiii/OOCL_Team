...
public class HighValueCargoFilter {
    public static void main(String[] args) {
        ...
        List<CargoItem> filteredCargo = allCargo.stream().filter(n -> n.value > threshold).toList();

        for (CargoItem cargoItem : filteredCargo) {
            System.out.println(cargoItem.id + " " + cargoItem.name + " " + cargoItem.weight + " " + cargoItem.value );
        }
