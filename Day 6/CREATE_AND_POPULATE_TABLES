...
ALTER TABLE `ORDER`
MODIFY COLUMN `DATE_ORDERED` DATE NOT NULL;

-- Insert into CUSTOMER (with CITY)
INSERT INTO CUSTOMER (CustomerID, FirstName, LastName, Email, Phone, City)
VALUES
(1, 'John', 'Smith', 'john.smith@email.com', '09171234567', 'Manila'),
(2, 'Maria', 'Garcia', 'maria.garcia@email.com', '09181234567', 'Cebu'),
(3, 'James', 'Johnson', 'james.johnson@email.com', '09221234567', 'Davao'),
(4, 'Ana', 'Santos', 'ana.santos@email.com', '09331234567', 'Quezon City'),
(5, 'Michael', 'Brown', 'michael.brown@email.com', '09451234567', 'Makati'),
(6, 'Sofia', 'Lopez', 'sofia.lopez@email.com', '09561234567', 'Taguig'),
(7, 'David', 'Wilson', 'david.wilson@email.com', '09671234567', 'Baguio'),
(8, 'Isabella', 'Martinez', 'isabella.martinez@email.com', '09781234567', 'Iloilo'),
(9, 'William', 'Anderson', 'william.anderson@email.com', '09891234567', 'Bacolod'),
(10, 'Olivia', 'Taylor', 'olivia.taylor@email.com', '09991234567', 'Zamboanga');

-- Insert into PRODUCT (with PRODUCT_TYPE)
INSERT INTO PRODUCT (ProductID, ProductName, Price, Stock, Product_Type)
VALUES
(1, 'Laptop', 45000, 10, 'Electronics'),
(2, 'Smartphone', 25000, 20, 'Electronics'),
(3, 'Refrigerator', 30000, 5, 'Appliances'),
(4, 'Microwave', 5000, 15, 'Appliances'),
(5, 'Office Chair', 3500, 25, 'Furniture'),
(6, 'Sofa Set', 25000, 3, 'Furniture'),
(7, 'T-shirt', 500, 50, 'Clothing'),
(8, 'Jeans', 1200, 40, 'Clothing'),
(9, 'Basketball', 800, 30, 'Sports'),
(10, 'Tennis Racket', 3000, 12, 'Sports');

SELECT * FROM `CUSTOMER`;

INSERT INTO `CUSTOMER` (`SURNAME`, `FIRST_NAME`, `EMAIL`, `CONTACT_NO`, `ADDRESS`, `CITY`) VALUES
('Brown', 'Charlie', 'charlie.brown@example.com', '321-654-0987', '12 Elm St, Springfield', 'Springfield'),
('Taylor', 'Emily', 'emily.taylor@example.com', '654-321-9870', '45 Birch Blvd, Rivertown', 'Rivertown'),
('Wilson', 'James', 'james.wilson@example.com', '777-888-9999', '78 Cedar Dr, Laketown', 'Laketown'),
('Anderson', 'Olivia', 'olivia.anderson@example.com', '222-333-4444', '90 Willow Way, Hillcrest', 'Hillcrest'),
('Thomas', 'Liam', 'liam.thomas@example.com', '999-888-7777', '102 Maple St, Meadowfield', 'Meadowfield'),
('Martin', 'Sophia', 'sophia.martin@example.com', '111-222-3333', '145 Oak St, Forestville', 'Forestville'),
('Lee', 'Ethan', 'ethan.lee@example.com', '444-555-6666', '67 Birch Rd, Brookside', 'Brookside'),
('Harris', 'Ava', 'ava.harris@example.com', '555-444-3333', '89 Spruce Ln, Westlake', 'Westlake'),
('Clark', 'Mason', 'mason.clark@example.com', '888-777-6666', '210 Pine St, Riverbend', 'Riverbend'),
('Lewis', 'Isabella', 'isabella.lewis@example.com', '666-555-4444', '305 Ash Ave, Eastpoint', 'Eastpoint');

-- PRODUCT (added PRODUCT_TYPE column)
INSERT INTO `PRODUCT` (`PRODUCT_NAME`, `PRICE`, `SELLER_ID`, `DESCRIPTION`, `PRODUCT_TYPE`) VALUES
('Smartphone', 800, 3, 'Latest model smartphone', 'Electronics'),
('Headphones', 50, 3, 'Noise-cancelling over-ear headphones', 'Electronics'),
('Desk Chair', 150, 4, 'Ergonomic office chair', 'Furniture'),
('Backpack', 40, 4, 'Durable travel backpack', 'Accessories'),
('Blender', 70, 5, 'High-speed kitchen blender', 'Appliances'),
('Coffee Maker', 120, 5, 'Automatic drip coffee maker', 'Appliances'),
('Gaming Keyboard', 90, 6, 'Mechanical RGB keyboard', 'Electronics'),
('Sneakers', 60, 6, 'Comfortable running shoes', 'Footwear'),
('Microwave Oven', 110, 7, 'Compact kitchen microwave', 'Appliances'),
('Smartwatch', 200, 7, 'Fitness tracking smartwatch', 'Electronics');

-- ORDER (DATE_ORDERED already matches NOT NULL constraint)
INSERT INTO `ORDER` (`MODE_OF_PAYMENT`, `DATE_ORDERED`, `STATUS`, `CUSTOMER_ID`, `ADDRESS`) VALUES
('Credit Card', '2023-10-29', 'Delivered', 3, '12 Elm St, Springfield'),
('PayPal', '2023-10-30', 'Processing', 4, '45 Birch Blvd, Rivertown'),
('Cash on Delivery', '2023-10-31', 'Shipped', 5, '78 Cedar Dr, Laketown'),
