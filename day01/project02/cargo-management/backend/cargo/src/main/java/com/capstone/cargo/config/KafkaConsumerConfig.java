...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "tracking");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Container> containerFactory(ConsumerFactory<String, Container> consumerFactory) {
