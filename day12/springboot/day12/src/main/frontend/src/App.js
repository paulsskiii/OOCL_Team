...
const API_URL = 'http://localhost:8080/api/personal-details/';
...
const App = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Reset the form
      setNewContainer({ containerNumber: '', origin: '', destination: '', weightKg: '' });
    } catch (e) {
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                      <div className="flex-1">
                        <p className="text-lg font-bold text-indigo-800">
                          Container ID: <span className="font-normal text-gray-700">{container.containerNumber}</span>
                        </p>
                        ...
                        <p className="text-gray-600 text-sm">
                          Weight: <span className="font-medium">{container.weightKg} kg</span>
                        </p>
                      </div>
