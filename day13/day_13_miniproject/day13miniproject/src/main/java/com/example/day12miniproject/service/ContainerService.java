...
import com.example.day12miniproject.ContainerConsumer;
import com.example.day12miniproject.ContainerProducer;
...
public class ContainerService {
    ...
    public Container addContainers(Container container) {
        ContainerProducer containerProducer = new ContainerProducer();
        containerProducer.addContainer(container);
