...
const Containers = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://localhost:8080/api/containers/add", {
        method: 'POST',
        headers: {
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                      <div className="flex-1">
                        <p className="text-lg font-bold text-indigo-800">
                          Container ID: <span className="font-normal text-gray-700">{container.id}</span>
                        </p>
                        ...
                        <p className="text-gray-600 text-sm">
                          Owner: <span className="font-medium">{container.owner}</span>
                        </p>
                      </div>
