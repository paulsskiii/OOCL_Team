...
public class HighValueCargoFilter {
    public static void main(String[] args) {
        ...
        List<CargoItem> thresholdCargo = allCargo.stream ()
            .filter (cargo -> cargo.getValue () > threshold)
            .collect (Collectors.toList ());

        System.out.println ("List of cargo items with a value greater than $" + threshold);
        for (CargoItem cargo : thresholdCargo)
