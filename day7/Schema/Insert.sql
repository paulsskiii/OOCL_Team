...
-- Address
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('90 Ludington Circle', '8392', 'Dayton', 52, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('32716 Artisan Point', '2739', 'Village', 14, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('25258 Waywood Circle', '65841', 'Mcbride', 41, '628532', null, 'Russia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('8 Lillian Court', '85', 'International', 80, null, null, 'Sudan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('2 Petterle Park', '1076', 'Bluestem', 24, null, null, 'Vietnam');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('7161 Lunder Crossing', '01', 'Roth', 8, 'D6W', null, 'Ireland');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('34 Clemons Lane', '4', 'Stone Corner', 15, '44505', 'Ohio', 'United States');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('47 Anniversary Circle', '18062', 'Tony', 65, '520-2541', null, 'Japan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('85 Mayer Terrace', '03657', 'Shelley', 3, null, null, 'Uruguay');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('102 Sutteridge Hill', '05', 'Prairieview', 23, null, null, 'Jamaica');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('705 Carpenter Pass', '35', 'Chive', 15, null, null, 'Honduras');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('4456 Daystar Park', '061', 'Dorton', 35, null, null, 'Syria');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('142 Donald Alley', '8172', 'Bunting', 61, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('446 Ruskin Junction', '237', 'Sunnyside', 60, '152014', null, 'Russia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('93 Hoffman Park', '4', 'Portage', 22, '694752', null, 'Russia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('229 Waywood Plaza', '4069', 'Di Loreto', 19, null, null, 'Sudan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('49946 Blue Bill Park Plaza', '7', 'Center', 33, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('61 Pankratz Pass', '1', 'Old Shore', 1, null, null, 'Vietnam');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('1 Scott Lane', '10', 'Delaware', 23, null, null, 'Peru');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('181 Summit Street', '82323', 'Corry', 41, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('088 Sunnyside Hill', '3408', 'North', 66, null, null, 'Vietnam');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('1 Atwood Crossing', '25158', 'Hansons', 4, null, null, 'Greece');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('32 4th Court', '223', 'Messerschmidt', 68, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('4 Mosinee Road', '62005', 'Nevada', 23, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('1 Leroy Court', '2', '6th', 7, '40-401', null, 'Poland');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('8501 Lien Alley', '186', 'Superior', 53, null, null, 'South Korea');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('19144 Welch Trail', '6', 'Ohio', 50, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('925 Bowman Place', '93', 'Dryden', 50, null, null, 'Djibouti');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('329 Crest Line Hill', '04', 'Pearson', 73, '963-4603', null, 'Japan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('74935 Russell Park', '9', 'Oriole', 40, '242622', null, 'Russia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('073 Cherokee Avenue', '853', 'Fair Oaks', 56, '630008', null, 'Colombia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('42317 Maple Drive', '1', 'Delaware', 44, '29980-000', null, 'Brazil');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('05959 Anhalt Court', '468', 'Ridgeway', 46, '3586', null, 'Argentina');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('7 Kennedy Court', '0', 'Moose', 15, null, null, 'Turkmenistan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('79 Sunfield Parkway', '5', 'Erie', 79, '36520-000', null, 'Brazil');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('098 Forest Road', '5', 'Crowley', 32, null, null, 'Botswana');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('2942 Hermina Center', '6166', 'Walton', 60, '627603', null, 'Russia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('92 Longview Pass', '51', 'Talmadge', 19, '50730', null, 'Pakistan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('58926 Lakewood Way', '6', 'Village', 43, '265 40', 'Skåne', 'Sweden');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('4961 Maple Wood Place', '76776', 'Fuller', 45, '2433', null, 'Philippines');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('771 Arapahoe Parkway', '4987', 'Village', 5, 'L2T', 'Alberta', 'Canada');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('1754 Village Park', '3', 'Sommers', 53, null, null, 'Vietnam');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('04 Warbler Road', '46', 'Forest', 67, null, null, 'Uzbekistan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('71566 Londonderry Trail', '957', 'Del Mar', 57, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('12 Nova Center', '6', 'Eastwood', 35, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('2 Holmberg Plaza', '23', 'Thackeray', 47, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('83658 Oak Valley Road', '0', 'Basil', 49, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('2106 Kennedy Parkway', '147', 'Melrose', 54, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('4998 Waubesa Road', '601', 'Boyd', 67, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('5 Farragut Lane', '0025', 'Village', 72, null, null, 'Peru');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('919 Gale Trail', '991', 'Ridgeway', 17, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('34354 Longview Circle', '8', 'Weeping Birch', 66, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('4 Buhler Avenue', '686', 'Schiller', 15, null, null, 'Peru');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('60230 Old Gate Way', '15927', 'Mallory', 39, '94604 CEDEX', 'Île-de-France', 'France');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('11 Village Terrace', '850', 'Esker', 44, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('62803 Old Gate Alley', '625', 'Portage', 69, '73210', null, 'Pakistan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('26 Fallview Center', '82', 'Heffernan', 22, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('557 Westport Alley', '4604', 'Wayridge', 80, null, null, 'Azerbaijan');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('94829 Tony Avenue', '89187', 'Thompson', 40, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('24980 Butterfield Terrace', '412', 'Melrose', 16, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('6 Bobwhite Center', '9', 'Waubesa', 62, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('7730 Alpine Hill', '1657', '8th', 45, null, null, 'Jamaica');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('17 Gale Point', '82', 'Tomscot', 12, null, null, 'Burundi');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('1 Macpherson Circle', '98', 'Monument', 12, null, null, 'Serbia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('9975 Anthes Crossing', '246', 'Grover', 36, '357329', null, 'Russia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('103 Jenifer Way', '36037', 'Oriole', 54, null, null, 'Indonesia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('5302 Haas Way', '35', 'Shopko', 5, '49544', 'Michigan', 'United States');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('01 Brown Junction', '52589', 'Stone Corner', 34, '5016', null, 'Philippines');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('3201 Jana Way', '31', 'Pleasure', 34, '1100', null, 'Philippines');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('2 Sycamore Circle', '0855', 'Brickson Park', 33, '20706', null, 'Costa Rica');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('9939 Dovetail Park', '11', 'Ridge Oak', 41, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('4816 Dahle Point', '12274', 'Melrose', 19, null, null, 'Peru');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('187 Orin Place', '88', 'Linden', 1, '1225', null, 'Macedonia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('14909 Graedel Junction', '749', 'Independence', 64, '1400', null, 'Macedonia');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('09 Sachs Drive', '646', 'Dennis', 51, 'V5A', 'British Columbia', 'Canada');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('01 Boyd Parkway', '3733', 'Kenwood', 59, null, null, 'Bosnia and Herzegovina');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('6340 Fallview Terrace', '99', 'Northview', 58, '19360-000', null, 'Brazil');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('1 Upham Drive', '5697', 'Veith', 54, null, null, 'Yemen');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('83643 Crowley Park', '8237', 'Arrowood', 18, null, null, 'China');
insert into Address (address_line1, address_line2, barangay, city_id, postal_code, region, country) values ('173 Florence Junction', '1', 'David', 49, null, null, 'Jordan');
...
("HANDED TO TRUCKING SERVICES"),("OUT FOR DELIVERY"),("DELIVERED"),("PACKAGE LOST");
